...
var action_descriptions: Dictionary[String, String] = {
    ...
    "Primary": "Primary action.\nTypically accepts a menu action.",
    "Secondary": "Secondary action.\nTypically rejects a menu action.",
    "Tertiary": "Tertiary action.\nUsed as the third-most decision/enemy during selection.",
    "Quaternary": "Quaternary action.\nOpens the inventory or makes you sprint in RPG segments.",
    "Quinary": "Auxiliary action.\nUsed as the fourth-most decision/enemy during selection."
}
